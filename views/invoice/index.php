...
<div class="invoice-index">
    ...
    <?php echo Html::input('hidden', 'moneda', $moneda, ['id' => 'moneda']); ?>
    <ul class="nav nav-tabs" id="dataTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="dt15-tab" data-bs-toggle="tab" data-bs-target="#dt15" type="button"
                role="tab">15 zile</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="dt30-tab" data-bs-toggle="tab" data-bs-target="#dt30" type="button"
                role="tab">30 zile</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="dt45-tab" data-bs-toggle="tab" data-bs-target="#dt45" type="button"
                role="tab">45 zile</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="dt60-tab" data-bs-toggle="tab" data-bs-target="#dt60" type="button"
                role="tab">60 zile</button>
        </li>
    </ul>
...
$this->registerJs(<<<JS
 $(document).ready(function() {
    ...
    let columns = [
        ...
        columns.push( {data: null, orderable: false,
           render: function(data, type, row) {  
            ...
            const deleteUrl = baseUrl + '/invoice/delete?id=' + row.id;                 
    ...
    return $('#dt' + days + 'Table').DataTable({
      processing: true,
      serverSide: true,      
      ajax: baseUrl + '/invoice/data?days=' + days+'&moneda='+moneda,
      ordering: true,
      autoWidth: true,
      responsive: true,
      scrollX:true,           
